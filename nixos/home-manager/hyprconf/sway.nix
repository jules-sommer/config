...
let
    ...
    swaync_config_path = "${homeDir}/_dev/.config/swaylock/config";
    swaync_conf_json_path = "${homeDir}/_dev/.config/swaync/config.json";
    swaync_styles_path = "${homeDir}/_dev/.config/swaync/style.css";
in
{
  ...
  home.file.${swaync_config_path}.text = ''
    ...
    image=${homeDir}/.sysart/zoebo-pfp.jpg
