...
let
  swaync_config_path =
    "${lib.jules.settings.home}/_dev/.config/swaylock/config";
  swaync_conf_json_path = "./swaync_conf.json";
  swaync_styles_path =
    "${lib.jules.settings.home}/_dev/.config/swaync/style.css";
  colorScheme = lib.jules.get_theme;
  palette = colorScheme;
in with lib.jules; {
  home.file.${swaync_conf_json_path}.text = ''
      {
  ...
  '';
  home.file.${swaync_config_path}.text = ''
    indicator-caps-lock
    ...
    font=Ubuntu
  '';
  home.file.${swaync_styles_path}.text = ''
    * {
        font-family: Ubuntu;
        font-weight: bolder;
    }
